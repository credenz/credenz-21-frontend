    ...
    <>
      ...
      <Container fluid className="contactpage">
        <Row>
          <Col md="7">
            <Container>
              <Row className="contactppl">
                <Col lg="4" sm="6" className="mt-2" data-aos="zoom-in" data-aos-duration="800" data-aos-easing="ease-in-sine" data-aos-offset="0" >
                ...
                <Col lg="4" sm="6" className="mt-2" data-aos="zoom-in" data-aos-duration="800" data-aos-easing="ease-in-sine" data-aos-offset="200" >
                  <div className="pplcard">
                    <div className="pplcont">
                      <Image
                        src="../Nandini.jpeg"
                ...
                <Col lg="4" sm="6" className="mt-2" data-aos="zoom-in" data-aos-duration="800" data-aos-easing="ease-in-sine" data-aos-offset="400" >
                  <div className="pplcard">
                    <div className="pplcont">
                      <Image
                        src="../Tanvi.jpeg"
              ...
              <Row>
                <Col xs="12" className="feedbkfrm" data-aos="fade-right" data-aos-duration="700" data-aos-easing="ease-in-sine" >
                  FeedBack
                </Col>
              </Row>
              <Row>
                <Col data-aos="fade-right" data-aos-duration="700" data-aos-easing="ease-in-sine" >
          ...
          <Col md="5" className="pict-map" data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease-in-sine" data-aos-offset="200" >
            <iframe
