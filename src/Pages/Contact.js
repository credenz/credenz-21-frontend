          ...
          <Container>
            ...
            <Row className="contactppl">
              <Col sm="4" className="mt-2">
                <Image src="../onkar.jpg" className="pplimages" fluid roundedCircle />
                <div> Omkar Litke </div>
              ...
              <Col sm="4" className="mt-2">
                <Image src="../durvesh.jpg" className="pplimages" fluid roundedCircle />
                <div> Durvesh Malpure </div>
                <div className="maillink"> <a href="mailto:durveshmalpurecoc@gmail.com">durveshmalpurecoc@gmail.com</a><br />
                  +91 9172952268</div>
              </Col>
              <Col sm="4" className="mt-2">
                <Image src="../rohan.jpeg" className="pplimages" fluid roundedCircle />
                <div> Rohan Pawar </div>
              ...
              <Col>
                <Form>
                  <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control type="text" placeholder="Enter Name" className="fdbkfrm"/>
                  </Form.Group>

                  <Form.Group className="mb-3" controlId="formBasicPassword">
                    <Form.Label>Message</Form.Label>
                    <Form.Control as="textarea" placeholder="Type Message" className="fdbkfrm" />
                  </Form.Group>
                  <Button className="mb-3 subbutton" color="#FF5001" type="submit">
                    Submit
                  </Button>
                </Form>
              </Col>
