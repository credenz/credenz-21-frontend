  ...
  return (
    ...
    >
      <div className="container">
        ...
        <h2 className="terms-subheader">Overview</h2>
        <p className="lead">
          This website is operated by PICT IEEE Student Branch. Throughout the
          site, the terms “we”, “us” and “our” refer to PICT IEEE Student
          Branch. PICT IEEE Student Branch offers this website, including all
        ...
        <h2 className="terms-subheader">SECTION 1 - ONLINE STORE TERMS</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 2 - GENERAL CONDITIONS</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 5 - PRODUCTS OR SERVICES</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 7 - OPTIONAL TOOLS</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 8 - THIRD-PARTY LINKS</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 10 - PERSONAL INFORMATION</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 12 - PROHIBITED USES</h2>
        <p className="lead">
        ...
        <p className="lead">
          In no case shall PICT IEEE Student Branch, our directors, officers,
        ...
        <h2 className="terms-subheader">SECTION 14 - INDEMNIFICATION</h2>
        <p className="lead">
          You agree to indemnify, defend and hold harmless PICT IEEE Student
          Branch and our parent, subsidiaries, affiliates, partners, officers,
        ...
        <h2 className="terms-subheader">SECTION 15 - SEVERABILITY</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 16 - TERMINATION</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 17 - ENTIRE AGREEMENT</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 18 - GOVERNING LAW</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 20 - CONTACT INFORMATION</h2>
        <p className="lead">
          Questions about the Terms of Service should be sent to us at
          pisb.credenz20@gmail.com.
        </p>
        <h1 className="terms-header">PRIVACY STATEMENT</h1>
        <h2 className="terms-subheader">
        ...
        <h2 className="terms-subheader">SECTION 2 - CONSENT</h2>
        <p className="lead">How do you get my consent?</p>
        <p className="lead">
        ...
        <p className="lead">How do I withdraw my consent?</p>
        <p className="lead">
          ...
          pisb.credenz20@gmail.com or mailing us at: Survey No. 27, Near,
          Trimurti Chowk, Bharati Vidyapeeth Campus, Dhankawadi, Pune,
          Maharashtra 411043
        </p>
        <h2 className="terms-subheader">SECTION 3 - DISCLOSURE</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 5 - THIRD-PARTY SERVICES</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">SECTION 6 - SECURITY</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">QUESTIONS AND CONTACT INFORMATION</h2>
        <p className="lead">
          ...
          pisb.credenz20@gmail.com or by mail at Survey No. 27, Near, Trimurti
          Chowk, Bharati Vidyapeeth Campus, Dhankawadi, Pune, Maharashtra 411043
        </p>
        <p className="lead">[Re: Privacy Compliance Officer]</p>
        <p className="lead">
          [622 Manglam Electronic Market Jaipur Rajasthan India 302001]
        </p>
        <h1 className="terms-header">Refund Policy</h1>
        <h2 className="terms-subheader">Returns</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">Refunds (if applicable)</h2>
        <p className="lead">
        ...
        <p className="lead">
          ...
          yet, please contact us at pisb.credenz20@gmail.com.
        </p>
        <h2 className="terms-subheader">Sale items (if applicable)</h2>
        <p className="lead">
          Only regular priced items may be refunded, unfortunately sale items
          cannot be refunded.
        </p>
        <h2 className="terms-subheader">Exchanges (if applicable)</h2>
        <p className="lead">
          We only replace items if they are defective or damaged. If you need to
          exchange it for the same item, send us an email at
          pisb.credenz20@gmail.com and send your item to: 622 Manglam Electronic
          Market Jaipur Rajasthan India 302001.
        </p>
        <h2 className="terms-subheader">Gifts</h2>
        <p className="lead">
        ...
        <h2 className="terms-subheader">Shipping</h2>
        <p className="lead">
